...
fun main() {
    greet("Borgo", "2021") // change it as you need
    remindName()
    guessAge()
    count()
    test()
...
fun count() {
    println("Now I will prove to you that I can count to any number you want. Write a positive number.")
...
fun test() {
    println("Completed!")
    println("Let's test your programming knowledge. Write the number of the correct answer.")
